...
<body style="margin:0;padding:0;background:#F7F6F3;font-family:'DM Sans',Arial,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:24px 16px;">
    ...
    <div style="background:#fff;padding:24px;text-align:center;border-radius:0 0 12px 12px;">
      <a href="https://topranker.com" style="display:inline-block;background:#C49A1A;color:#fff;text-decoration:none;padding:14px 32px;border-radius:24px;font-size:14px;font-weight:700;">
        Open TopRanker
      </a>
    </div>
    ...
    <div style="text-align:center;padding:24px;font-size:11px;color:#aaa;">
      ...
      <div style="margin-top:8px;">
        <a href="https://topranker.com/settings" style="color:#aaa;text-decoration:underline;">Manage preferences</a>
        &nbsp;&middot;&nbsp;
        <a href="https://topranker.com/unsubscribe" style="color:#aaa;text-decoration:underline;">Unsubscribe</a>
      </div>
    </div>
  </div>
</body>
